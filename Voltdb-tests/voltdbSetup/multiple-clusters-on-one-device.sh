...
voltdb init --force -C deployment.xml -D $WORKING_DIR/node1 
voltdb init --force -C deployment.xml -D $WORKING_DIR/node2
voltdb init --force -C deployment.xml -D $WORKING_DIR/node3
